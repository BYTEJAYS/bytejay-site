...
export class Map
{
    ...
    setLocations()
    {
        ...
        this.locations.items = [
            ...
            { name: 'Under<br /> the hood', respawnName: 'behindTheScene', offset: { x: 0.01, y: 0 } },
            { name: 'Bowling', respawnName: 'bowling', offset: { x: -0.08, y: 0.03 } },
            { name: 'My Journey', respawnName: 'career', offset: { x: 0, y: -0.06 } },
            ...
            { name: 'ByteJay', respawnName: 'landing', offset: { x: 0.02, y: 0 } },
            { name: 'Projects', respawnName: 'projects', offset: { x: 0, y: -0.02 } },
            { name: 'Let’s Talk', respawnName: 'social', offset: { x: -0.01, y: -0.04 } },
            { name: 'Journey Page', respawnName: 'timeMachine', offset: { x: 0, y: 0 } },
        ]
